...
export const StepBlock = () => {
  return (
    <div className="p-8">
      <p className="text-center text-xl">当アプリの使用方法について</p>
          ...
          <div className="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
            <div className="flex relative pb-12">
              ...
              <div className="flex-grow pl-4">
                ...
                <p className="leading-relaxed">ご自身のログイン情報を作成した後にログインしてください。</p>
              </div>
            </div>
            <div className="flex relative pb-12">
              <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
              ...
              <div className="flex-grow pl-4">
                ...
                <p className="leading-relaxed">常備薬管理アプリへと遷移してください</p>
              </div>
            </div>
            <div className="flex relative pb-12">
              <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
              ...
              <div className="flex-grow pl-4">
                ...
                <p className="leading-relaxed">お持ちの常備薬を項目ごとに入力してください</p>
              </div>
            </div>
            <div className="flex relative pb-12">
              <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
